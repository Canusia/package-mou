...
class MOUEditorForm(forms.Form):
    ...
    mou_text = forms.CharField(
        ...
        label='MOU Text',
        required=False,
        help_text='Customize with {{signature_1}}, {{signature_2}}, {{signature_3}}, {{signature_4}}, {{highschool_name}}, {{highschool_ceeb}}, {{academic_year}}, {{teacher_list}}, {{dual_enrollment_teacher_list}}, {{pathways_teacher_list}}, {{pathways_course_list}},  {{dual_enrollment_course_list}}',
        validators=[validate_html_short_code]
    )
